# Benchmark Script: Koorde Only
# This script runs only the Koorde benchmark
...
Write-Host "  Koorde Web Cache Benchmark (Only)" -ForegroundColor Cyan
Write-Host "============================================" -ForegroundColor Cyan
Write-Host ""
...
Write-Host "Koorde Results:"
Write-Host "Total Requests: $($koordeResults.TotalRequests)"
Write-Host "Success Rate:   $("{0:P2}" -f $koordeResults.SuccessRate)"
Write-Host "Avg Latency:    $("{0:F2} ms" -f $koordeResults.AvgLatency)"
Write-Host "P95 Latency:    $("{0:F2} ms" -f $koordeResults.P95Latency)"
